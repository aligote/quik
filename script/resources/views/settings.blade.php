			...
			<div class="row">
						...
						<div class="settings-main-menu">
							<nav>
								<ul class="nav nav-tabs">
									...
									<li><a href="#verify" data-toggle="tab" class="active" id="verifylink"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm106.5 150.5L228.8 332.8h-.1c-1.7 1.7-6.3 5.5-11.6 5.5-3.8 0-8.1-2.1-11.7-5.7l-56-56c-1.6-1.6-1.6-4.1 0-5.7l17.8-17.8c.8-.8 1.8-1.2 2.8-1.2 1 0 2 .4 2.8 1.2l44.4 44.4 122-122.9c.8-.8 1.8-1.2 2.8-1.2 1.1 0 2.1.4 2.8 1.2l17.5 18.1c1.8 1.7 1.8 4.2.2 5.8z"></path></svg> {{ __('Verification') }}</a></li>
				...
				<div class="col-lg-8">
					<div class="tab-content">
						<div class="setting-main-area verification_area tab-pane fade" id="avatar">
						...
						<div class="setting-main-area tab-pane fade in active show" id="verify">
							<div class="settings-content-area">
								...
								<div class="review-verification text-center">
									...
									<div class="review-info">
										...
										<div>Your account will be verified within 24 hours.<br>A notification will be sent to your email..</div>
									</div>
								</div>
								@elseif($verification && $verification->status == 'approved')
								<div class="review-verification text-center" id="verifiedmsg">
									<i class="far fa-check-circle"></i>
									<div class="review-info">
										<h4>{{ __('Congratulations, you are verified. Thanks for verifying your ID') }}</h4>
										@foreach ($verifications as $verif)
										<div class="text-left">- {{$verif->first_name}} {{$verif->last_name}}</div>
										@endforeach
										<div>If you plan to upload videos with another person or multiple people before they on your account, these steps must be repeated for each person individually. If other people appear in your videos who did not follow these steps before they appeared on your account, your videos with that person may be deleted.</div>
										<div class="settings-btn"><button class="withdraw_button" id="addpersonbtn" style="margin:auto;" type="button">Add Additional Person</button></div>
									</div>
								</div>
								@else
								<script>
								...
								<div>
								Verification of your account is required to verify your identity and restrict content uploads to persons under the age of 18.<br>
All verification images are totally private, only seen by leak.fun staff and stored securely.<br>
To correctly verify your account, please read verification rules.</div>
<div id="accordion">
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        1. You are at least 18 years old or the age of majority in your jurisdiction.<br>
2. Images may not be edited, cropped or re-sized;<br>
3. All images must be in color;<br>
4. Documents must be a photo or a scanned copy.<br>
5. Digitally modified text or images will be rejected.<br>
6. You cannot wear a mask or sunglasses in the picture.<br>
7. The photo must show most of your face.<br>
8. All 4 corners of the document must be visible.<br>
9. Any ID uploaded must be valid.<br>
10. Files must be .PNG or .JPG format and under 7MB in size;<br>
      </div>
    </div>
  </div>
</div>
								<img src="/uploads/verifyinstr.jpg" id="verifyinstr">
								<div>If your submitted documents do not meet all of the above requirements, your application will be rejected and you will receive a message explaining why your verification attempt failed.</div>
								<form action="{{ route('profile.verification') }}" method="POST" id="verification_form">
									...
									<div class="settings-form">
										<div class="row">
											...
											<div class="col-lg-8">
												<div class="nation-card-content">
													<h4>{{ __('Verification image') }}</h4>
													<p>{{ __('A photo of you holding up a sign with your username and leak.fun written on it') }}</p>
										...
										<div class="row">
											<div class="col-lg-4">
												<div class="upload-national-card" id="selfieimage_card">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="nation-card-content">
													<h4>{{ __('Selfie with your Passport or ID') }}</h4>
													<p>{{ __('Your selfie with passport/ID in your hands') }}</p>
													<a href="#"><label for="selfieimage"><i class="fas fa-upload"></i> {{ __('Choose File') }} </label></a>
													<input type="file" name="selfieimage" id="selfieimage" class="d-none">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-lg-4">
												<div class="upload-national-card" id="verifyimage_card">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="nation-card-content">
													...
													<a href="#"><label for="pasportidmage"><i class="fas fa-upload"></i> {{ __('Choose File') }} </label></a>
													<input type="file" name="verifyimage" id="pasportidmage" class="d-none">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-lg-4">
												<div class="upload-national-card" id="secondimage_card">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="nation-card-content">
													<h4>{{ __('Second ID (optional)') }}</h4>
													<p>{{ __('Please select a recent picture of your passport or id') }}</p>
													<a href="#"><label for="secondimage"><i class="fas fa-upload"></i> {{ __('Choose File') }} </label></a>
													<input type="file" name="secondimage" id="secondimage" class="d-none">
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="form-group">
													<input type="text" class="form-control" placeholder="{{ __('Date of birth (DD.MM.YYYY)') }}" name="birthdate">
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group">
