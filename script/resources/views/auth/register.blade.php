...
<!-- main area start -->
<script>
var inp = '<input type="hidden" name="ncapt" id="ncapt" value="<?php echo md5(date('d.m.Y'). 'qick.fun'); ?>">';
</script>
<section>
                            ...
                            <div class="login-form">
                                <form action="{{ route('register') }}" method="POST" id="regform">
                                    ...
                                    <div class="login-form-gorup">
										...
										<a href="javascript:void(0);" id="showregpass">Show</a>
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="login-form-button">
                                        <button type="submit" id="regbtn">{{ __('Sign up') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
