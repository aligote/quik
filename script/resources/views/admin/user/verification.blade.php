							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<tr>
										<td>{{ $key + 1 }}</td>
										<td>
											<a href="{{ asset($verification->image) }}"><img class="table_img" src="{{ asset($verification->image) }}"></a>
											<a href="{{ asset($verification->selfieimage) }}"><img class="table_img" src="{{ asset($verification->selfieimage) }}"></a>
											<a href="{{ asset($verification->secondimage) }}"><img class="table_img" src="{{ asset($verification->secondimage) }}"></a>
											@if ($verification->verifyimage)<a href="{{ asset($verification->verifyimage) }}"><img class="table_img" src="{{ asset($verification->verifyimage) }}"></a>@endif
										</td>
										...
										<td>{{ $verification->first_name }} {{ $verification->last_name }} | {{ $verification->message }} | {{ $verification->birthdate }}</td>
										<td>
