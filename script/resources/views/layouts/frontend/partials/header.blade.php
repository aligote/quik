                ...
                <div class="col-lg-3">
                    <div class="header-right-section f-right">
                        ...
                        <div class="upload-btn">
                            ...
                            @if(Session::get('mode')['id'] == 'night')
                             {{-- <a class="pjax" href="{{ route('upload') }}"><img id="upload_mode" class="upload" src="{{ asset('frontend/img/white_upload.png') }}" alt=""></a>
                              --}}
                              <x-welcome.homelinkupload>Upload</x-welcome.homelinkupload>
                            @else
                        ...
                        <div class="upload-btn d-block mr-2 ">
                            @if(Session::has('mode'))
                            @if(Session::get('mode')['id'] == 'night')
                            <x-welcome.homelinkupload>
                                {{-- <img id="upload_mode" class="upload" src="{{ asset('frontend/img/white_upload.png') }}" alt=""> --}}
                                Upload
                            </x-welcome.homelinkupload>
                            @else
                            <x-welcome.homelinkupload>Upload</x-welcome.homelinkupload>
                        ...
                        <x-welcome.homelink>{{ __('Login') }}</x-welcome.homelink>
                        @endif
                    </div>
                </div>
            </div>
