...
Route::get('/category/{id}','WelcomeController@getByCategory')->name('get.category')->middleware('two_factor');
...
Route::post('video/videopol','VideoController@videopol');
Route::post('video/genrandvid','VideoController@genrandvid');
...
Route::group(['as'=>'admin.','prefix'=>'admin','namespace'=>'Admin','middleware'=>['admin','auth']],function(){
	...
	Route::get('user/achievments','UserController@achievments')->name('user.achievments');
	Route::get('user/saveachievments','UserController@saveachievments')->name('user.saveachievments');
...
*/
// video show routes
Route::get('{username}/{id}/{slug}','VideoController@show')->name('video.show')->middleware('two_factor');
