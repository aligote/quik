(function($) {
  ...
  /*------------------------------------------
    ...
    $(".achivs").change(function(){
        var checked = $(this).is(":checked")==true?1:0;
        var achiev = $(this).attr("rel").split("|")[0];
        var uid = $(this).attr("rel").split("|")[1];
        $.get("/admin/user/saveachievments", {checked: checked, achiev: achiev, uid: uid});
    });
